...
//Button attributes
word buttons_colorText, buttons_colorTextInactive, buttons_colorBackGround, buttons_colorBorder, buttons_colorHilite;
//Button fonts
uint8_t *buttons_fontText, *buttons_fontSymbol;
